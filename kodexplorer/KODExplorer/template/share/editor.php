...
<head>
	...
	<link href="<?php echo STATIC_PATH;?>style/bootstrap.css?ver=<?php echo KOD_VERSION;?>" rel="stylesheet"/><link rel="stylesheet" href="/plugins/kodexplorer/KODExplorer/static/style/font-awesome/css/font-awesome.css">
	<link rel="stylesheet" href="/plugins/kodexplorer/KODExplorer/static/style/font-awesome/css/font-awesome.css">
	<!--[if IE 7]>
	<link rel="stylesheet" href="/plugins/kodexplorer/KODExplorer/static/style/font-awesome/css/font-awesome-ie7.css">
	<![endif]-->

	
	<link href="<?php echo STATIC_PATH;?>style/skin/simple/app_editor.css?ver=<?php echo KOD_VERSION;?>" rel="stylesheet" id='link_css_list'/>
			...
			<div class="frame-right-main"  style="height:100%;padding:0;margin:0;">
				...
				<div class ='frame'>
					 <iframe name="OpenopenEditor"
					  src="/plugin/kodexplorer/admin_index/index.html?share/edit&user=<?php echo $_GET['user'];?>&sid=<?php echo $_GET['sid'];?>" 
...
<script src="/plugin/kodexplorer/admin_index/index.html?share/common_js&user=<?php echo $_GET['user'];?>&sid=<?php echo $_GET['sid'];?>&#=<?php echo rand_string(8);?>"></script>
