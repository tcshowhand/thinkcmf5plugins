	...
	<div class="frame-main">
		...
		<div class='frame-right'>
			<div class="frame-right-main"  style="height:100%;padding:0;margin:0;">
				...
				<div class ='frame'>
					 <iframe name="OpenopenEditor" src="/plugin/kodexplorer/admin_index/index.html?editor/edit" style="width:100%;height:100%;border:0;" frameborder=0></iframe>
				</div>	
			</div>
		</div><!-- / frame-right end-->
	</div><!-- / frame-main end-->
...
<script src="/plugin/kodexplorer/admin_index/index.html?user/common_js#id=<?php echo rand_string(8);?>"></script>
